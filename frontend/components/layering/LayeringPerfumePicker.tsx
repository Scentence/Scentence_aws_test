    ...
    return (
        <div className="relative" ref={containerRef}>
            ...
            <button
                ...
                className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all ${isOpen ? 'bg-[#C5A55D] text-white shadow-md' : 'text-gray-400 hover:text-[#C5A55D] hover:bg-[#F5F2EA]'}`}
                title="내 향수 불러오기"
            >
